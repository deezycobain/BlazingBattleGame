...
(()=>{
 ...
 async function boot(){
  ...
  try{
   ...
   try{sessionStorage.setItem('bb.bootDiagnostics',JSON.stringify(events.slice(-40)))}catch{}
   location.replace('game.html?boot=1');
  }catch(e){
