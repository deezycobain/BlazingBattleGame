...
replaceOnce(
 ...
 `const targetColor=!jutsu
       ? (comboLinked?'#39ff88':activePlayer?.name==='Tyler'?'#ffbd4a':'#ffffff')
       : (isUltimateAction(activePlayer)?'#ff3548':'#45d7ff');`,
 'Tyler valid-target amber ring'
);
