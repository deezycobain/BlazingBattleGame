...
.bb-home-theme .bb-home-actions [data-bb-home-action="road"],
.bb-home-theme .bb-home-actions [data-bb-home-action="castle"]{
...
.bb-home-theme .bb-home-actions [data-bb-home-action="road"]{grid-column:1/4!important;grid-row:1!important}
.bb-home-theme .bb-home-actions [data-bb-home-action="castle"]{grid-column:4/7!important;grid-row:1!important}
...
@media(max-width:620px){
  .bb-home-theme .bb-home-actions [data-bb-home-action="road"]{grid-column:1/7!important;grid-row:1!important}
  .bb-home-theme .bb-home-actions [data-bb-home-action="castle"]{grid-column:1/7!important;grid-row:2!important}
...
for(const marker of [
  STYLE_ID,
  'grid-template-columns:repeat(6,minmax(0,1fr))!important',
  '[data-bb-home-action="road"]{grid-column:1/4!important;grid-row:1!important}',
  '[data-bb-home-action="castle"]{grid-column:4/7!important;grid-row:1!important}',
  '[data-bb-home-action="castle"]{grid-column:1/7!important;grid-row:2!important}',
...
console.log('Home grid finalize PASS: featured modes and secondary navigation pinned to deterministic six-column cells.');
