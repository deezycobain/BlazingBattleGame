...
async function run(name,type){
 ...
 try{
  ...
  console.log(`Itachi battle smoke PASS (${name}): crow flock plus full-viewport authored Tsukuyomi overlay/mandala/target cinematic, AoE damage, and 45 gauge suppression verified.`);
  await context.close();
