...
async function waitHome(page){
  ...
  await page.waitForFunction(()=>typeof window.BlazingEconomy==='object'&&typeof window.BlazingUnitProgression==='object'&&typeof window.BlazingRoadRun==='object'&&typeof window.BlazingApprovedHomeCompat==='object'&&typeof window.BlazingHomeV9Lifecycle==='object',{timeout:30000});
...
async function run(name,type){
  ...
  try{
    ...
    const persisted=await page.evaluate(()=>({economy:window.BlazingEconomy.load(),progression:window.BlazingUnitProgression.getState(),road:window.BlazingRoadRun.loadRun()}));
