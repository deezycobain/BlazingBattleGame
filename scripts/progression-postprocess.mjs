...
for(const marker of ['RESONANCE FORGE','blazing.progression.v1','MAX_RESONANCE=5','STAT_BUDGET=12','summonEmbers=999999','spendEmbers=function()','SHINY AWAKENED','KEEP CURRENT','ACCEPT NEW','CORE RESONANCE BANNER','SKIP TO RESULTS','bb-shiny-awakening','current_collection_card.png','senku_card.jpeg','unit_details_cosmic_wish.jpeg','FORGE_ART','SHINY_CUTOUT','full_art_absolute_zero_v2.jpeg','shiny_foreground_cutout_v2.webp','shiny_foreground_cutout_v1.webp','forgeArtDepth','forgePopout','hasPopout','forgeHoloTexture','bbGoldFlow','overflow-y:auto!important','PULL${pulls.length===1','fitForgeArtwork','--forge-art-ratio','--forge-art-max'])if(!html.includes(marker))throw new Error(`Progression pass missing ${marker}`);
await fs.writeFile(file,html);
console.log('Progression pass applied: inventory-themed summons, canonical full-card art, layered Shiny pop-outs, skippable reveals, Shiny-to-Forge routing, and persistent Resonance progression.');
