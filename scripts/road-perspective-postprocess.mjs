...
const replacement=`const bbRoadDepthY=Number(y);
...
console.log('Road perspective PASS: map-authored depth scale uses actor feet-Y in world space and remains render-only.');
