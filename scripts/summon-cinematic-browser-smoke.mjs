...
async function run(name,type){
  ...
  try{
    ...
    if(runtime.version!=='5.8.0-itachi'||runtime.timeline?.resonance?.done!==3660||runtime.timeline?.resonance?.cardEnter!==1500||runtime.timeline?.resonance?.flip!==2020||runtime.timeline?.resonance?.resolve!==2670)throw new Error(`unexpected cinematic contract: ${JSON.stringify(runtime)}`);
