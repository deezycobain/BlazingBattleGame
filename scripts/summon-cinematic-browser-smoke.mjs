...
async function run(name,type){
  ...
  try{
    ...
    if(runtime.version!=='6.17.0-itachi-long-rings'||runtime.timeline?.resonance?.done!==3660||runtime.timeline?.resonance?.cardEnter!==1500||runtime.timeline?.resonance?.flip!==2020||runtime.timeline?.resonance?.resolve!==2670||runtime.timeline?.itachi?.handoff!==5200)throw new Error(`unexpected cinematic contract: ${JSON.stringify(runtime)}`);
