...
console.log('Sub-Zero facing PASS: live preview stays non-sticky; committed resolved-target lock supersedes preview; gameplay and Freeze Blast visual tuning remain unchanged.');
